// Todo el texto de la landing vive acá. Para cambiar una frase de la web,
// se edita este archivo — no hace falta tocar ningún componente.
...
export const premium = {
  eyebrow: "CUANDO QUIERAS IR MÁS PROFUNDO",
  titulo: "¿Y si ya no querés solamente mantener tu sueño vivo?",
...
export const paraQuienEs = {
  titulo: "Esto puede ser para vos si...",
  items: [
    "Tenés algo que hace demasiado tiempo llamás “algún día”.",
    "Sabés que querés un cambio, aunque todavía no tengas toda la ruta.",
    "Te cansaste de consumir inspiración sin convertirla en decisiones.",
    "Querés avanzar sin abandonar todo lo demás que también importa en tu vida.",
  ],
};
